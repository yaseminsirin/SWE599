...
SEMANTIC_SEARCH_SCAN_MULTIPLIER = int(os.getenv("SEMANTIC_SEARCH_SCAN_MULTIPLIER", "10"))
SEMANTIC_SEARCH_SCAN_FLOOR = int(os.getenv("SEMANTIC_SEARCH_SCAN_FLOOR", "120"))
SEMANTIC_SEARCH_SCAN_CAP = int(os.getenv("SEMANTIC_SEARCH_SCAN_CAP", "600"))
SEMANTIC_SEARCH_NARROWED_SCAN_CAP = int(os.getenv("SEMANTIC_SEARCH_NARROWED_SCAN_CAP", "250"))
SEMANTIC_SEARCH_HNSW_EF_SEARCH = int(os.getenv("SEMANTIC_SEARCH_HNSW_EF_SEARCH", "40"))
# Scopes with fewer job IDs use job_id__in; larger scopes use index-first post-filtering.
SEMANTIC_SEARCH_INDEX_FIRST_MIN_SCOPE = int(os.getenv("SEMANTIC_SEARCH_INDEX_FIRST_MIN_SCOPE", "6000"))
SEMANTIC_RERANK_WEIGHT_SEMANTIC = float(os.getenv("SEMANTIC_RERANK_WEIGHT_SEMANTIC", "0.55"))
SEMANTIC_RERANK_WEIGHT_LEXICAL = float(os.getenv("SEMANTIC_RERANK_WEIGHT_LEXICAL", "0.25"))
SEMANTIC_RERANK_WEIGHT_ROLE = float(os.getenv("SEMANTIC_RERANK_WEIGHT_ROLE", "0.20"))
