...
SEMANTIC_SEARCH_SCAN_MULTIPLIER = int(os.getenv("SEMANTIC_SEARCH_SCAN_MULTIPLIER", "15"))
SEMANTIC_SEARCH_SCAN_FLOOR = int(os.getenv("SEMANTIC_SEARCH_SCAN_FLOOR", "300"))
SEMANTIC_SEARCH_SCAN_CAP = int(os.getenv("SEMANTIC_SEARCH_SCAN_CAP", "1500"))
